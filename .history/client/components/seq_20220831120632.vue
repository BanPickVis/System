...
export default {
    ...
    methods: {
        render_seq_veiw() {
            ...
            var leftMost_stage = seq_view_data.nodes[0].stage;
            console.log(leftMost_stage);
            var stage_width = 145;
            var seq_zoomed = d3
                .zoom()
                .scaleExtent([0.563, 10])
                .translateExtent([
                    [10, 0],
                    [2556 + 55 - leftMost_stage * stage_width, 100000],
                ])
            ...
            function render_title() {
                ...
                var title_view = d3
                    ...
                    .attr(
                        "transform",
                        `translate(-${leftMost_stage * stage_width},0)`
                    );

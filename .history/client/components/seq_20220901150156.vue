...
<script>
import all_gly_data from "../assets/json/seq_view_output.json";
...
export default {
    ...
    methods: {
        ...
        render_glyph_view(chosen_hero) {
            d3.json(
                "../data/glyph_view_output_2022.json",
                function (all_hero_data) {
                    var chosen_hero_data = all_hero_data[chosen_hero];
                    ...
                    ////////kda_arc///////////
                    //////////////////////////
                    var kda_percent_list =
                        chosen_hero_data["kda_percent"].reverse();
                    var kda_arc = glyph_view_svg
                        .append("g")
                        .attr("id", "kda_arc");
                    ...
                    kda_arc
                        ...
                        .attr("class", "kda_arc")
                        .attr("d", (d) => {
                            end_angle = start_angle + (Math.PI / 2) * d;

    ...
    methods: {
        ...
        render_seq_left_veiw() {
            ...
            node_g
                ...
                .on("mouseout", mouseout)
                .on("click", function (d) {
                    this.chosen_hero = d.hero;
                    self.render_glyph_view();
                    var block = $("#seq_view_svg_left").css("transform");
                    // console.log(block);
                    // console.log(source_ele_transform);
        ...
        async render_glyph_view() {
            //////////////////////////
            /////////input////////////
            //////////////////////////
            // this.chosen_hero = "太乙真人";
            console.log(this.chosen_hero);
            var chosen_hero_data = await all_glyph_data[this.chosen_hero];
            ...
            glyph_view_svg
                .append("circle")
                .attr("id", "cur_hero")
                .style("fill", `url(#p${this.chosen_hero})`)
                .attr("r", cur_hero_r)
                .attr("stroke", "black")
                .attr("stroke-width", 1)
                .attr("transform", `translate(${offset_left},${offset_top})`);

<template>
    <div>
        <!-- Header -->
        <svg width="635" height="96" viewBox="0 0 640 96" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <!-- BG -->
            <path d="M0 0H640V96H0V0Z" fill="url(#bg_gradient)" />

            <!-- avatars -->
            <rect id="player1hero" x="19" y="12" width="75.315" height="71.3206" rx="35.6603" fill="url(#pnone)" shape-rendering="crispEdges" filter="url(#trans-shadow)" />
            <rect id="player2hero" x="540" y="9" width="75.315" height="71.3206" rx="35.6603" fill="url(#pnone)" shape-rendering="crispEdges" filter="url(#trans-shadow)" />

            <!-- name -->
            <text y="50" fill="#333333" style="
            ...
            <defs>
                <linearGradient id="bg_gradient" x1="0" y1="318.046" x2="640" y2="318.046" gradientUnits="userSpaceOnUse">
        ...
        <span class="hero_select">
            <el-select v-model="select_hero_1" placeholder="Select" style="width: 130px">
                <el-option v-for="item in heros1" :key="item" :label="item" :value="item" />
            </el-select>
            vs

            <el-select v-model="select_hero_2" placeholder="Select" style="width: 130px">
                <el-option v-for="item in heros2" :key="item" :label="item" :value="item" />
            </el-select>
        </span>
        <br />

        <!-- Box Plot -->
        <svg id="player_box_plot" width="640" height="390" viewBox="0 0 640 400" fill="none" xmlns="http://www.w3.org/2000/svg"></svg>
    </div>
</template>
...
export default {
    ...
    watch: {
        ...
        select_hero_1(val, _) {
            ...
            console.log('chineseTrans(val) is: ', chineseTrans(val));
